...
const directoryPath = './Voicelines/Laserpointer/Jadiz/';
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const audio = [
            './Voicelines/Laserpointer/Jadiz/Laserpoint_Crafting_Materiels_-_Pickups_01.ogg', 
            './Voicelines/Laserpointer/Jadiz/Laserpoint_Crafting_Materiels_-_Pickups_02.ogg', 
            './Voicelines/Laserpointer/Jadiz/Laserpoint_Crafting_Materiels_-_Pickups_03.ogg'
