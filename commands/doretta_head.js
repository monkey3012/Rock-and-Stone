...
const directoryPath = './Voicelines/Doretta/Head/';
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('doretta_head')
        .setDescription("Let's save Doretta!"),
    async execute(interaction) {
        ...
        const audio = [
            './Voicelines/Doretta/Head/DorettaheadSaved_1.ogg',
            './Voicelines/Doretta/Head/LaserPointerDorettaHead_1.ogg',
            './Voicelines/Doretta/Head/LaserPointerDorettaHead_2.ogg',
            './Voicelines/Doretta/Head/LaserPointerDorettaHead_3.ogg',
            './Voicelines/Doretta/Head/LaserPointerDorettaHead_4.ogg',
            './Voicelines/Doretta/Head/LaserPointerDorettaHead_5.ogg',
            './Voicelines/Doretta/Head/LaserPointerDorettaHead_6.ogg',
            './Voicelines/Doretta/Head/LaserPointerDorettaHead_7.ogg',
            './Voicelines/Doretta/Head/LaserPointerDorettaHead_8.ogg'
