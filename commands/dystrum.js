...
const directoryPath = './Voicelines/Laserpointer/Dystrum/';
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('dystrum')
        .setDescription('I found some Dystrum!'),
    async execute(interaction) {
        ...
        const audio = [
            './Voicelines/Laserpointer/Dystrum/Laserpoint_Dystrum_01.ogg', 
            './Voicelines/Laserpointer/Dystrum/Laserpoint_Dystrum_02.ogg', 
            './Voicelines/Laserpointer/Dystrum/Laserpoint_Dystrum_03.ogg', 
            './Voicelines/Laserpointer/Dystrum/Laserpoint_Dystrum_04.ogg', 
            './Voicelines/Laserpointer/Dystrum/Laserpoint_Dystrum_04a.ogg'
