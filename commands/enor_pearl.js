...
const directoryPath = './Voicelines/Laserpointer/Enor Pearl/';
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('enor_pearl')
        .setDescription('Found an Enor Pearl!'),
    async execute(interaction) {
        ...
        const audio = [
            './Voicelines/Laserpointer/Enor Pearl/Laserpoint_Crafting_Materiels_-_Pickups_04.ogg', 
            './Voicelines/Laserpointer/Enor Pearl/Laserpoint_Crafting_Materiels_-_Pickups_05.ogg', 
            './Voicelines/Laserpointer/Enor Pearl/Laserpoint_Crafting_Materiels_-_Pickups_06.ogg'
