...
const directoryPath = './Voicelines/Laserpointer/Gold/';
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const audio = [
            './Voicelines/Laserpointer/Gold/Laserpoint_Gold_01.ogg', 
            './Voicelines/Laserpointer/Gold/Laserpoint_Gold_01a.ogg', 
            './Voicelines/Laserpointer/Gold/Laserpoint_Gold_01b.ogg', 
            './Voicelines/Laserpointer/Gold/Laserpoint_Gold_02.ogg', 
            './Voicelines/Laserpointer/Gold/Laserpoint_Gold_03.ogg', 
            './Voicelines/Laserpointer/Gold/Laserpoint_Gold_04.ogg', 
            './Voicelines/Laserpointer/Gold/Laserpoint_Gold_04a.ogg'
