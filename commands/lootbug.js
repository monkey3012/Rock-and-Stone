...
const directoryPath = './Voicelines/Passive/Loot Bug/';
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const audio = [
            './Voicelines/Passive/Loot Bug/Ping/LootBugs_01.ogg',
            './Voicelines/Passive/Loot Bug/Ping/LootBugs_2.ogg',
            './Voicelines/Passive/Loot Bug/Ping/LootBugs_3.ogg',
            './Voicelines/Passive/Loot Bug/Ping/LootBugs_4.ogg',
            './Voicelines/Passive/Golden Loot Bug/Ping/GoldenLootbugLaserPointer_1.ogg',
            './Voicelines/Passive/Golden Loot Bug/Ping/GoldenLootbugLaserPointer_2.ogg',
            './Voicelines/Passive/Golden Loot Bug/Ping/GoldenLootbugLaserPointer_3.ogg',
            './Voicelines/Passive/Golden Loot Bug/Ping/GoldenLootbugLaserPointer_4.ogg'
