...
const directoryPath = './Voicelines/Steeve/Pet/';
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('pet_steeve')
        .setDescription("Steeve! You are my bestest friend!"),
    async execute(interaction) {
        ...
        const audio = [
            './Voicelines/Steeve/Pet/PettingSteve_01.ogg',
            './Voicelines/Steeve/Pet/PettingSteve_02.ogg',
            './Voicelines/Steeve/Pet/PettingSteve_03.ogg',
            './Voicelines/Steeve/Pet/PettingSteve_04.ogg',
            './Voicelines/Steeve/Pet/PettingSteve_05.ogg',
            './Voicelines/Steeve/Pet/PettingSteve_06.ogg',
            './Voicelines/Steeve/Pet/PettingSteve_07.ogg',
            './Voicelines/Steeve/Pet/PettingSteve_08.ogg',
            './Voicelines/Steeve/Pet/PettingSteve_09.ogg',
            './Voicelines/Steeve/Pet/PettingSteve_10.ogg',
            './Voicelines/Steeve/Pet/PettingSteve_11.ogg'
        ];
