...
const directoryPath = './Voicelines/Shouts/Dwarf Shout in Space Rig/';
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const audio = [
            './Voicelines/Shouts/Dwarf Shout in Space Rig/Dwarf_Fart_08.ogg', 
            './Voicelines/Shouts/Dwarf Shout in Space Rig/Dwarf_Misc_03_fart_Javiere.ogg', 
            './Voicelines/Shouts/Dwarf Shout in Space Rig/Dwarf_Misc_07_burp_Javiere.ogg', 
            './Voicelines/Shouts/Dwarf Shout in Space Rig/Dwarf_Misc_09_burp_Javiere.ogg', 
            './Voicelines/Shouts/Dwarf Shout in Space Rig/Dwarf_Misc_14_spit_Javiere.ogg', 
            './Voicelines/Shouts/Dwarf Shout in Space Rig/Dwarf_Misc_15_spit_Javiere.ogg'
        ];
